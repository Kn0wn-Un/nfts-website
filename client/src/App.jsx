      ...
      <div className="container">
        <div className="header-container">
         ...
         {currentAccount === "" ? (
          ...
          ) : userNftToken ? (<div className="sub-text">Congratulations, you own an Neon Sun NFT! <a href={`https://testnets.opensea.io/assets/${CONTRACT_ADDRESS}/${userNftToken}`}>🌊 View Collection on OpenSea</a>(It may take a while)</div>) : (
            <button onClick={askContractToMintNft} className="cta-button connect-wallet-button" disabled={userNftToken}>
